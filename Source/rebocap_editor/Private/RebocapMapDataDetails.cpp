...
void FRebocapMapDataDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
    ...
    [
        ...
        [
            ...
            .ToolTipText(FText::FromString(TEXT("将当前所选预设的骨骼名称批量填充到下方输入框中。")))
            .OnClicked_Lambda([ObjectsBeingCustomized, &DetailBuilder]() -> FReply {
                for (auto& WeakObj : ObjectsBeingCustomized)
                {
                    ...
                    {
                        MapData->ApplyPreset(MapData->PresetTemplate);
            ...
            [
                SNew(STextBlock)
                .Text(FText::FromString(TEXT("🔄 一键填充当前预设")))
                .Font(FAppStyle::GetFontStyle(TEXT("NormalFontBold")))
            ]
        ]
        + SHorizontalBox::Slot()
        .AutoWidth()
        .Padding(2.0f, 4.0f, 4.0f, 4.0f)
        [
            SNew(SButton)
            .ButtonStyle(FAppStyle::Get(), "Button")
            .ContentPadding(FMargin(8.0f, 3.0f))
